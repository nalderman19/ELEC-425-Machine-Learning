...
while true
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % get min column number for each data point (row)
    [mn, membership] = min(distances,[],2)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % get mean of all data points beloning to each cluster
    for i = 1:n_cluster
